...
import { AddUserAddressRequest } from "../../../redux-saga/actions/UserSetting";
import {
  GetUserCityRequest,
...
export default function AddressAdd(props) {
  ...
  const { addressType } = useSelector((state) => state.userSettingState);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      dispatch(AddUserAddressRequest(payload));
