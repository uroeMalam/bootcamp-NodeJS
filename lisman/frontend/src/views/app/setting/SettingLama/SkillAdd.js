...
import { GetSkillTypeRequest } from "../../../redux-saga/actions/UserSetting";
import { AddUserSkillRequest } from "../../../redux-saga/actions/UserSetting";

export default function SkillAdd(props) {
  const { skillType } = useSelector((state) => state.userSettingState);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      dispatch(AddUserSkillRequest(payload));
      props.closeAdd();
