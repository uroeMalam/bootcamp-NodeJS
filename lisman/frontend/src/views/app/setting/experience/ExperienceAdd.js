...
import { AddExperienceRequest } from "../../../../redux-saga/actions/MasterSetting";
import { GetCityRequest } from "../../../../redux-saga/actions/UserDrop";

export default function ExperienceAdd(props) {
  const dispatch = useDispatch();
  const { city } = useSelector((state) => state.userDropState);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      dispatch(AddExperienceRequest(payload));
      props.closeAdd();
      props.refresh();
          ...
          <div className="border border-slate-500 m-5">
            ...
            <div>
              ...
              <div>
                ...
                <div className="mt-3 ml-16 flex items-center ">
                  <label htmlFor="usex_employment_type" className="mr-9 -ml-14">
                    Employment Type
                  </label>
                  <select
                ...
                <div className="mt-3 ml-16 flex items-center mb-10 ">
                  <label htmlFor="usex_experience_type" className="mr-9 -ml-11">
                    Experience Type
                  </label>
                  <select
