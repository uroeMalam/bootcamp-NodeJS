...
(
    ...
    CONSTRAINT boap_entity_unique UNIQUE (boap_entity_id),
    CONSTRAINT boap_prog_unique UNIQUE (boap_prog_id),
...
(
    ...
    bor_status varchar(15),
    bapr_roac_id integer,
    CONSTRAINT bootcamp_apply_progress_pkey PRIMARY KEY (bapr_id, bapr_prog_id, bapr_entity_id),
    CONSTRAINT bootcamp_apply_progress_bapr_entity_id_fkey FOREIGN KEY (bapr_entity_id)
        REFERENCES bootcamp_apply(boap_entity_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT bootcamp_apply_progress_bapr_prog_id_fkey FOREIGN KEY (bapr_prog_id)
        REFERENCES bootcamp_apply(boap_prog_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
